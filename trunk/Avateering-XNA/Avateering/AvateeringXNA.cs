...
namespace Microsoft.Samples.Kinect.Avateering
{
    ...
    public class AvateeringXNA : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            //this.currentModel = Content.Load<Model>("tiny");
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            // Draw the actual bag 3D model
            if (null != this.bagAnimator)
            {
                this.bagAnimator.leftHandSkin = this.animator.GetLeftHandSkinMatrix();
                this.bagAnimator.leftHandWorld = this.animator.GetLeftHandWorldMatrix();
                this.bagAnimator.Draw(gameTime, Matrix.Identity, this.view, this.projection);
            }
