    ...
    public abstract class PhysicObject : DrawableGameComponent
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            if (model != null)
            {
                ...
                if ( this.Game.GetType() == typeof(JiggleGame) )
                {
                    camera = ((JiggleGame)this.Game).Camera;
                }
                else if (this.Game.GetType() == typeof(XnaBasics))
                {
                    camera = ((XnaBasics)this.Game).GameCamera;
                }
            ...
            bool isJiggleGame = this.Game.GetType() == typeof(JiggleGame);

            if (isJiggleGame && ((JiggleGame)this.Game).DebugDrawer.Enabled )
            {
