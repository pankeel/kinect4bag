...
namespace Microsoft.Samples.Kinect.XnaBasics
{
    ...
    public class AvateeringXNA : Microsoft.Xna.Framework.Game
    {
        ...
        public AvateeringXNA()
        {
            ...
            this.bagAnimator = new BagRender(this);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            //this.SharedSpriteBatch.Begin(SpriteSortMode.Immediate, BlendState.AlphaBlend,null,null,null);
